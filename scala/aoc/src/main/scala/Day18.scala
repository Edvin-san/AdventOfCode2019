object Day18 {
    // Find recursion. Does not matter how we arrived at a state to figure out the optimal path forward. Use dynamic programming.
    ...
    def part1(s: String = puzzleInputPart1) = {
        ...
        println(s"vault has ${vault.keyPos.size} keys, yielding ${math.pow(2, vault.keyPos.size)} key combinations to explore (worst case)")
        val pathFinder = new PathFinder()
        pathFinder.shortestPath(vault)
    }

    def part2(s: String = puzzleInputPart2) = {
        part1(s)
    }
    ...
    */
    ...
    ########################
    #f.D.E.e.............@.# (a, b, c) Next e or d? e is closer but not optimal.
    ######################.#
    #d.....................#
    ########################

    ########################                    ########################
    #f.D...@...............# (a, b, c, e)       #f...E.e...............# (a, b, c, d)
    ######################.#                    ######################.#
    #d.....................#                    #@.....................#
    ########################                    ########################

    ########################                    ########################
    #f.....................# (a, b, c, e, d)    #f.....@...............# (a, b, c, d, e)
    ######################.#                    ######################.#
    #@.....................#                    #......................#
    ########################                    ########################
    ...
    */
    ...
    // Algorithm perform bad on this input. Too high branching factor.
    val scaryInput = 
    """
    #################################
    #..a..b..c..d..e..f..g..h..i..j.#
